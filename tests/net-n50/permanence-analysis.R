...
membership.path = "membership0.txt"
...
for(clu.id in 1:k){
    ...
    print(I[v.int.indexs])
    print(Emax[v.int.indexs])
    print(D[v.int.indexs])
    ...
    print(Cin[v.int.indexs])
    print(penalization.term)
    print("!!!")
    print(P.scores[v.int.indexs])
    print("-----------------------")
}
print("Cin")
print(Cin)
...
print(Cin[c(0,5,9,19,27)+1])
print(P.scores[c(0,5,9,19,27)+1])
...
print(Pn.scores)
print("!")
print(Pn.scores[c(0,5,9,19,27)+1])
...
print(eigen.scores)
print("!")
print(eigen.scores[c(0,5,9,19,27)+1])
}
